...
let totalTime = brushHair+brushTeeth+eatBreakfast+dogsOut+getDressed
...
let haveToDo = brushTeeth+getDressed
let likeToDo = brushHair+eatBreakfast
let otherToDo = dogsOut
