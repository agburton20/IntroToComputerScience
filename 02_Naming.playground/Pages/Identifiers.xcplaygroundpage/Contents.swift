...
let totalNumberOfAnimals = numberOfDogs + numberOfCats + numberOfTurtles + numberOfHamsters + 1

let totalNumberOfMammals = numberOfDogs + numberOfCats + numberOfHamsters + 1
let numberOfPigs = 3

let numberOfIguanas = 1
